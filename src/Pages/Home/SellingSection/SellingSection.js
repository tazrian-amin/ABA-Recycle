        ...
        <div className="hero bg-gradient-to-r from-orange-100 via-blue-300 to-pink-300 border border-black w-4/5 mx-auto rounded-none md:rounded-md my-10">
            <div className="hero-content flex-col lg:flex-row">
                ...
                <div className='text-center lg:text-left'>
                    ...
                    <Link to='/sell' className="btn bg-gradient-to-r from-red-200 to-sky-200 hover:from-red-300 hover:to-sky-300 rounded-md hover:font-bold text-black">Start Selling</Link>
                </div>
            </div>
        </div>
    );
